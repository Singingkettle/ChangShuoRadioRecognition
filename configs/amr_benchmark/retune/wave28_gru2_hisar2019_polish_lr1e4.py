"""Wave-28: GRU2@Hisar polish — FT the 68.51 baseline best at LR 1e-4.

Fresh-recipe attempts regressed (selfnorm-aug 61.16, augment-free 62.47);
the baseline model is the pair's peak, so ratchet from it instead.
"""
_base_ = ['../../gru2/gru2_iq-shape-L-F-hisar-2019.py']
load_from = (
    'work_dirs/amr_benchmark/gru2/hisar2019/best_accuracy_top1_epoch_106.pth')
