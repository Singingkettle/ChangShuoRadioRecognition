"""Wave-18 Tier-B: Hisar FT from wave-17 Keras-recipe best (67.595 vs 75).
...
"""
_base_ = ['../../petcgdnn/petcgdnn_iq-shape-L-F-hisar-2019.py']

load_from = 'work_dirs/amr_benchmark_retune/petcgdnn/hisar2019/amrb_plateau_w17/best_accuracy_top1_epoch_135.pth'
