...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            dict(type='LoadConstellationFromCache', data_root=data_root, file_name='train_and_validation_filter_size_0.020_stride_0.020.pkl', to_float32=True),
    ...
    val=dict(
        ...
        ann_file='test.json',
        pipeline=[
            dict(type='LoadConstellationFromCache', data_root=data_root, file_name='test_filter_size_0.020_stride_0.020.pkl', to_float32=True),
