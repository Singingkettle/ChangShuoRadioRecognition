...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            dict(type='LoadIQFromCache', data_root=data_root, file_name='train_and_validation_ap.pkl', to_float32=True),
    ...
    val=dict(
        ...
        ann_file='test.json',
        pipeline=[
            dict(type='LoadIQFromCache', data_root=data_root, file_name='test_ap.pkl', to_float32=True),
            dict(type='LoadAPFromIQ'),
