# MLDNN calibration on the RadioML.2018.01A 50%/10% development split.
...
train_pipeline = [
    ...
    dict(type='MLDNNIQToAP', phase_order='imag_over_real'),
...
val_evaluator = [
    dict(type='StreamingAccuracy', expected_samples=255216,
         expected_world_size=1),
    dict(type='StreamingLoss', task='classification',
         expected_samples=255216, expected_world_size=1),
]
