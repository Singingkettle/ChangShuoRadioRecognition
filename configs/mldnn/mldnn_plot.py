    ...
    snr_modulation=[
        ...
        dict(
            ...
            method=[
                ...
                # V5
                dict(
                    config='mldnn_abl-bigru-safn-mtlh_iq-ap-deepsig_201610A',
                    name='MLDNN-V5',
                ),
                # V6
                dict(
        ...
        # # deepsig 201801A SNR[-8,20] compare with I/Q A/P
        # dict(
        #     type='AccuracyF1Plot',
        ...
        # ),
        #
        # # deepsig 201801A SNR[-8,20] compare with constellation and fb
        # dict(
        #     type='AccuracyF1Plot',
