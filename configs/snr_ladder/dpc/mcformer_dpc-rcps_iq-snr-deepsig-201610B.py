...
work_dir = 'work_dirs/dpc_smoke/amc/deepsig201610B/mcformer_dpc-rcps'
    ...
    head=dict(
        loss=dict(
            ...
            base=dict(
                ...
                source='work_dirs/dpc_teacher_posteriors/deepsig201610B/mcformer_hard-ce_seed2026_train.npz',
                laplace=1e-4,
                temperature=1.0,
                prior_blend=0.25,
