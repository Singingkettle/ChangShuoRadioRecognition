...
work_dir = 'work_dirs/rcps_hybrid_2018A/amc/deepsig201801A/petcgdnn_rcps-hybrid-eps01'
    ...
    head=dict(
        loss=dict(
            ...
            base=dict(
                ...
                source='work_dirs/rcps_tables/deepsig201801A/petcgdnn_hard-ce_seed2026_reliability_base.npz',
                laplace=1e-4,
                temperature=1.0,
                prior_blend=0.5,
...
experiment_note = 'Conservative class-level RCPS-Hybrid pilot for 2018A after sample-posterior DPC failed validation.'
