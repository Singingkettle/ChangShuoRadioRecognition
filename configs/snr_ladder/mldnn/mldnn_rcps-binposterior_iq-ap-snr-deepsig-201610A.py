# RCPS per-bin posterior route of the audited spectrum.
...
work_dir = 'work_dirs/amc/deepsig201610A/mldnn_rcps-binposterior'

_posterior_base = 'work_dirs/mldnn_supervision_400ep/posterior_bases/deepsig201610A_mldnn_hardce_validation_meanprob.npz'
_rcps_loss = dict(
