# RCPS retention-weighted route of the audited spectrum.
...
_base_ = ['./mldnn_rcps-retention_iq-ap-snr-deepsig-201610A.py']

work_dir = 'work_dirs/strict_split_400ep/amc/deepsig201610A/mldnn_rcps-retention-strict'
