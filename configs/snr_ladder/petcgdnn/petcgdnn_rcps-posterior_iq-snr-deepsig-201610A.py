...
work_dir = 'work_dirs/amc/deepsig201610A/petcgdnn_rcps-posterior'
    ...
    head=dict(
        loss=dict(
            ...
            base=dict(
                ...
                source='work_dirs/rcps_tables/deepsig201610A/petcgdnn_hard-ce_seed2026_reliability_base.npz',
                laplace=1e-4,
                temperature=1.0,
                prior_blend=0.5,
