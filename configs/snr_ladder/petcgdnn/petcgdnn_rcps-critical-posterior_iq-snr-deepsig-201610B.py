...
work_dir = 'work_dirs/amc/deepsig201610B/petcgdnn_rcps-critical-posterior'
...
model = dict(head=dict(loss=dict(
    ...
    base=dict(
        ...
        source='work_dirs/rcps_tables/deepsig201610B/petcgdnn_hardce_3seed_validation_meanprob_t2.npz',
        laplace=1e-4,
        temperature=1.0,
        prior_blend=0.25,
