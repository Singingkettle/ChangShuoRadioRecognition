...
work_dir = 'work_dirs/synthetic_awgn/cgdnet_strict-awgn-dpc'
method_name = 'strict_awgn_dpc_rcps'
strict_dpc_source = 'work_dirs/synthetic_awgn/teacher_posteriors/cgdnet_strict_awgn_dpc_trainval.npz'
