...
work_dir = 'work_dirs/synthetic_awgn/mcformer_critical-strict-dpc'
method_name = 'critical_strict_awgn_dpc_rcps'

strict_dpc_source = 'work_dirs/synthetic_awgn/teacher_posteriors/mcformer_stage1_seed2026_30ep_strict_awgn_dpc_trainval.npz'
