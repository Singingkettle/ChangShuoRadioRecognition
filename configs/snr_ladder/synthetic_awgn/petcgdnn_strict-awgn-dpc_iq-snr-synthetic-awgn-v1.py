...
work_dir = 'work_dirs/synthetic_awgn/petcgdnn_strict-awgn-dpc'
method_name = 'strict_awgn_dpc_rcps'

strict_dpc_source = 'work_dirs/synthetic_awgn/teacher_posteriors/petcgdnn_strict_awgn_dpc_trainval.npz'
