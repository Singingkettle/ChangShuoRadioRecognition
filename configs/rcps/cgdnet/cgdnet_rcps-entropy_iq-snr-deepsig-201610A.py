...
work_dir = '/home/citybuster/Data/RCPS/work_dirs/amc/deepsig201610A/cgdnet_rcps-entropy'
...
model = dict(
    head=dict(
        loss=dict(
            ...
            epsilon=dict(
                type='entropy_match',
                source='/home/citybuster/Data/RCPS/work_dirs/rcps_tables/deepsig201610A/cgdnet_hard-ce_seed2026_entropy_match.npz'),
