...
work_dir = '/home/citybuster/Data/RCPS/work_dirs/amc/deepsig201610A/gru2_rcps-posterior'
    ...
    head=dict(
        loss=dict(
            ...
            base=dict(
                ...
                source='/home/citybuster/Data/RCPS/work_dirs/rcps_tables/deepsig201610A/gru2_hard-ce_seed2026_reliability_base.npz',
                laplace=1e-4,
                temperature=1.0,
                prior_blend=0.5,
