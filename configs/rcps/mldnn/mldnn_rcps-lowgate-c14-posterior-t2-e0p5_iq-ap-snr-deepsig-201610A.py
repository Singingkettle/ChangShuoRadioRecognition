...
work_dir = '/home/citybuster/Data/RCPS/work_dirs/amc/deepsig201610A/mldnn_rcps-lowgate-c14-posterior-t2-e0p5'
...
_rcps_loss = dict(
    ...
    base=dict(type='reliability_confusion', source=_posterior_base, laplace=1e-4, temperature=2.0),
