_base_ = ['./mcformer_hard-ce_iq-snr-synthetic-awgn-v1.py']

work_dir = '/home/citybuster/Data/RCPS/work_dirs/synthetic_awgn/mcformer_highsnr-teacher'
method_name = 'highsnr_teacher_hard_ce'

high_snr_filter = dict(type='FilterBySNR', save_range=(10, 18))
