...
work_dir = '/home/citybuster/Data/RCPS/work_dirs/dpc_smoke/amc/deepsig201610A/mcformer_dpc-entproj'
    ...
    head=dict(
        loss=dict(
            ...
            base=dict(
                ...
                source='/home/citybuster/Data/RCPS/work_dirs/dpc_teacher_posteriors/deepsig201610A/mcformer_hard-ce_seed2026_train.npz',
                laplace=1e-4,
                temperature=1.5,
                prior_blend=1.0,
