...
work_dir = '/home/citybuster/Data/RCPS/work_dirs/amc/hisar2019/petcgdnn_rcps-critical-posterior'
...
model = dict(head=dict(loss=dict(
    ...
    base=dict(
        ...
        source='/home/citybuster/Data/RCPS/work_dirs/rcps_tables/hisar2019/petcgdnn_hardce_3seed_validation_meanprob_t2.npz',
        laplace=1e-4,
        temperature=1.0,
        prior_blend=0.25,
