...
_base_ = 'mmdet::dab_detr/dab-detr_r50_8xb2-50e_coco.py'

# Axis-C cross-detector cell: DAB-DETR (anchor-box query DETR) on the SAME STFT3 memmap input as the RTMDet cells,
...
load_from = None
resume = False
work_dir = 'work_dirs/torchsig_mmdet_stft3_memmap_dab_detr_stft3_memmap_resize512'
