...
# Axis-C cross-detector cell: DINO (4-scale deformable-attention DETR, denoising) on the SAME STFT3 memmap input as the RTMDet cells,
...
load_from = None
resume = False
work_dir = 'work_dirs/torchsig_mmdet_stft3_memmap_dino_stft3_memmap_resize512'
