...
# Axis-C cross-detector cell: Sparse R-CNN (learnable proposals + dynamic head, RoIAlign) on the SAME STFT3 memmap input as the RTMDet cells,
...
load_from = None
resume = False
work_dir = 'work_dirs/torchsig_mmdet_stft3_memmap_sparse_rcnn_stft3_memmap_resize512'
