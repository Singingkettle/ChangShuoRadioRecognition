...
# Axis-C cross-detector cell: Conditional DETR (vanilla-attention query-based) on the SAME STFT3 memmap input as the RTMDet cells,
...
load_from = None
resume = False
work_dir = 'work_dirs/torchsig_mmdet_stft3_memmap_conditional_detr_stft3_memmap_resize512'
