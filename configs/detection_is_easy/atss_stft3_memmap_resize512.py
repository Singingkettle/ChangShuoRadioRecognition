...
_base_ = 'mmdet::atss/atss_r50_fpn_1x_coco.py'

# Axis-C cross-detector cell: ATSS (R50-FPN, anchor-based with adaptive sample selection) on the SAME STFT3
# memmap input, 57-class via --root coco_multiclass. Only the detector family changes. Harness sets
# data_root/classes/num_classes, backbone.in_channels (=3), memmap loader channels, and preprocessor stats.
...
load_from = None
resume = False
work_dir = 'work_dirs/torchsig_mmdet_stft3_memmap_atss_r50'
