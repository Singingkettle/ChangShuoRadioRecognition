...
# Axis-C cross-detector cell: RetinaNet (R50-FPN, anchor-based one-stage, focal loss) on the SAME STFT3 memmap input as the RTMDet cells,
...
load_from = None
resume = False
work_dir = 'work_dirs/torchsig_mmdet_stft3_memmap_retinanet_stft3_memmap_resize512'
