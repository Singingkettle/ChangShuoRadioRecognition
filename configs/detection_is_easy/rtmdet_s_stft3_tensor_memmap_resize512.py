...
# Axis-B (model complexity): RTMDet-S on the hardshort-lowsnr STFT3 memmap, 57-class via --root coco_multiclass.
...
work_dir = 'work_dirs/torchsig_mmdet_stft3_tensor_memmap_resize512_rtmdet_s'
