...
def repo_root() -> Path:
    """Locate the CSRR clone from this file so a fresh checkout runs against
    itself, never a machine-specific path."""
...
def main() -> int:
    ...
    if not full_path.exists():
        cmd = [sys.executable, "-u", "configs/detection_is_easy/bridge.py", "build-pred",
