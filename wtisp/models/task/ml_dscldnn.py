...
class MLDSCLDNN(BaseAMC):
    ...
    def init_weights(self, pre_trained=None):
        ...
        Args:
            pre_trained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(MLDSCLDNN, self).init_weights(pre_trained)
    ...
    def forward_train(self, iqs, aps, cos, snr_labels, mod_labels, low_weight, high_weight):
