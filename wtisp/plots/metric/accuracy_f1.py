...
from .utils import (load_amc_evaluation_results, reorder_results,
                    radar_factory, get_classification_accuracy_and_f1_for_plot)
...
class AccuracyF1Plot(object):
    def __init__(self, log_dir, name, legend, method, extra_predictions=None, legend_config=None):
        ...
        self.SNRS = None
        self.CLASSES = None
        self.snr_accuracies, self.modulation_f1s = self.get_accuracy_f1()
