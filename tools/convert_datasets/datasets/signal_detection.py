...
from .base_dataset import combine_two_infos
...
class CSRRData:
    def __init__(self, root_dir, version, data_ratios):
        self.organization = 'ChangShuo'
        self.root_dir = root_dir
        self.version = version
        self.data_dir = osp.join(self.root_dir, self.organization, self.version)
        self.anno_dir = osp.join(self.root_dir, self.organization, self.version, 'anno')
        self.train_num = 0
        self.val_num = 0
        self.test_num = 0
    ...
    def generate(self):
        try:
            ...
            print('\nSave train, val, test annotation json for the data set {}-{}'.format(self.organization,
                                                                                          self.version))
