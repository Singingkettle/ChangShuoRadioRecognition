...
CONFIGS = {
    ...
    ('gru2', 'hard-ce-rcps-meta'): 'configs/rcps/gru2/gru2_hard-ce_iq-snr-deepsig-201610A.py',
    ('gru2', 'static-ls'): 'configs/rcps/gru2/gru2_static-ls_iq-snr-deepsig-201610A.py',
    ('gru2', 'rcps-uniform'): 'configs/rcps/gru2/gru2_rcps-uniform_iq-snr-deepsig-201610A.py',
    ('gru2', 'rcps-retention'): 'configs/rcps/gru2/gru2_rcps-retention_iq-snr-deepsig-201610A.py',
    ('gru2', 'rcps-confusion'): 'configs/rcps/gru2/gru2_rcps-confusion_iq-snr-deepsig-201610A.py',
    ('gru2', 'rcps-entropy'): 'configs/rcps/gru2/gru2_rcps-entropy_iq-snr-deepsig-201610A.py',
    ('gru2', 'rcps-posterior'): 'configs/rcps/gru2/gru2_rcps-posterior_iq-snr-deepsig-201610A.py',
    ...
    ('mcldnn_hisar', 'static-ls'): 'configs/rcps/mcldnn/mcldnn_static-ls_iq-snr-hisar2019.py',
    ('mcldnn_hisar', 'rcps-hybrid'): 'configs/rcps/mcldnn/mcldnn_rcps-hybrid-eps01_iq-snr-hisar2019.py',
    ('mcldnn_hisar', 'rcps-critical-posterior'): 'configs/rcps/mcldnn/mcldnn_rcps-critical-posterior_iq-snr-hisar2019.py',
    ...
    ('petcgdnn_10b', 'rcps-critical-posterior'): 'configs/rcps/petcgdnn/petcgdnn_rcps-critical-posterior_iq-snr-deepsig-201610B.py',
    ...
    ('petcgdnn_hisar', 'rcps-critical-posterior'): 'configs/rcps/petcgdnn/petcgdnn_rcps-critical-posterior_iq-snr-hisar2019.py',
    ...
    ('petcgdnn_kerasinit', 'rcps-entropy'): 'configs/rcps/parity/petcgdnn_rcps-entropy_kerasinit_iq-snr-deepsig-201610A.py',
    ('petcgdnn_kerasinit', 'rcps-posterior'): 'configs/rcps/parity/petcgdnn_rcps-posterior_kerasinit_iq-snr-deepsig-201610A.py',
