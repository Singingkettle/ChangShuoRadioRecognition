...
targets ([`paper_figure_targets.md`](paper_figure_targets.md)), historical
pre-mmengine inventory ([`paper_and_history_notes.md`](paper_and_history_notes.md)).
...
python tools/test_det.py \
    configs/jdm/experiments/retune/eval_ideal_v1_det_voted.py \
    work_dirs/jdm/retune/det_full_120ep_lr1e3/best_detection_mAP_epoch_*.pth
python tools/test_det.py \
    configs/jdm/experiments/retune/eval_simulate_real_awgn_det_testonly.py \
    work_dirs/jdm/retune/det_full_120ep_lr1e3/best_detection_mAP_epoch_*.pth
```
...
The operating-point detector is `configs/jdm/experiments/retune/det_full_120ep_lr1e3.py`
...
Configs under `configs/jdm/experiments/retune/` are the protocol evals and the
search log that produced the operating point. They are not a second architecture.
