...
with open('/home/citybuster/Data/SignalProcessing/Workdir/mldnn_iq-ap-deepsig201610A/mldnn_new.pth', 'wb') as f:
       torch.save(checkpoint, f)
       f.flush()


checkpoint = torch.load('/home/citybuster/Data/SignalProcessing/Workdir/mldnn_iq-ap-deepsig201610A/mldnn_new.pth',
                        map_location='cpu')
