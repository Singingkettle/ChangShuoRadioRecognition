...
class Config:
    ...
    Example:
        ...
        >>> cfg.b.b1
        [0, 1]
        >>> cfg = Config.fromfile('tests/data/config/mydis.py')
        >>> cfg.filename
        "/home/kchen/projects/mmcv/tests/data/config/mydis.py"
        >>> cfg.item4
        'test'
        >>> cfg
        "Config [path: /home/kchen/projects/mmcv/tests/data/config/mydis.py]: "
    ...
    def dump(self, file=None):
        ...
        if file is None:
            ...
            return csrr.dump(cfg_dict, file=file, file_format=file_format)
