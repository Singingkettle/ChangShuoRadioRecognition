...
from csrr.models.utils import RandomBatchAugment
from csrr.registry import HOOKS, MODEL_WRAPPERS, MODELS
    ...
    Args:
        schedule (list): Every item of the schedule list should be a dict, and
            ...
            - ``batch_augments`` (dict | None, optional): The new batch
              ...
              <csrr.models.utils.batch_augments>` for more details.
