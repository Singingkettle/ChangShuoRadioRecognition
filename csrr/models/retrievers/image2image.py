...
from csrr.utils import track_on_main_process
...
class ImageToImageRetriever(BaseRetriever):
    ...
    Args:
        ...
        head (dict, optional): The head module to calculate loss from
            processed features. See :mod:`csrr.models.heads`. Notice
    ...
    def __init__(self,
        ...
        data_preprocessor.setdefault('type', 'csrr.ClsDataPreprocessor')
