...
class SignalClassifier(BaseClassifier):
    ...
    Args:
        backbone (dict): The backbone module. See
            :mod:`csrr.models.backbones`.
        neck (dict, optional): The neck module to process features from
            backbone. See :mod:`csrr.models.necks`. Defaults to None.
        head (dict, optional): The head module to do prediction and calculate
            loss from processed features. See :mod:`csrr.models.heads`.
    ...
    def forward(self,
        ...
        Returns:
            ...
            - If ``mode="predict"``, return a list of
              :obj:`csrr.structures.DataSample`.
        ...
        if mode == 'tensor':
            ...
            return self.diagnose(inputs, data_samples)
        elif mode == 'predict':
    ...
    def extract_feat(self, inputs, stage='neck'):
        ...
        Examples:
            ...
            >>> from csrr.models import build_classifier
            >>>
    ...
    def diagnose(self,
                 ...
                 **kwargs) -> List[DataSample]:
        feats = self.extract_feat(inputs)
        return self.head.diagnose(feats, data_samples, **kwargs)
