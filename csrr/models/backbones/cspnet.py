...
class CSPNet(BaseModule):
    ...
    Example:
        ...
        >>> import torch
        >>> import torch.nn as nn
        >>> from csrr.models import CSPNet
        >>> from csrr.models.backbones.resnet import Bottleneck
        >>>
...
class CSPDarkNet(CSPNet):
    ...
    Example:
        >>> from csrr.models import CSPDarkNet
        >>> import torch
...
class CSPResNet(CSPNet):
    ...
    Args:
        ...
        init_cfg (dict or list[dict], optional): Initialization config dict.
            Default: None.
    Example:
        >>> from csrr.models import CSPResNet
        >>> import torch
...
class CSPResNeXt(CSPResNet):
    ...
    Args:
        ...
        init_cfg (dict or list[dict], optional): Initialization config dict.
            Default: None.
    Example:
        >>> from csrr.models import CSPResNeXt
        >>> import torch
