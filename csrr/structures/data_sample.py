...
from .utils import LABEL_TYPE, SCORE_TYPE, LOSS_TYPE, format_label, format_score, format_loss
...
class DataSample(BaseDataElement):
    ...
    The following fields are convention names in csrr, and we will set or
    ...
    def set_loss(self, value: LOSS_TYPE, name: str):
        """Set ``loss``."""
        self.set_field(format_loss(value), name, dtype=torch.Tensor)
        return self
