...
from csrr.registry import DATASETS, DATA_FILTERS, TRANSFORMS
...
class BaseClassificationDataset(_BaseDataset):
    ...
    Args:
        ...
        max_refetch (int): If ``Basedataset.prepare_data`` get a None data.
            The maximum extra number of cycles to get a valid data.
            Defaults to 1000.
    ...
    def __init__(self,
                 ...
                 classes: Union[str, Sequence[str], None] = None) -> None:
    ...
    def filter_data(self) -> List[dict]:
        ...
        if self.filter_cfg is not None:
            for cfg in self.filter_cfg:
                ...
                self.data_list = f(self.data_list, self._metainfo)
