...
#         confusion_matrix = get_confusion_matrix(num_snr, mod_label_num, item_snr_index, sub_results, item_mod_label)
...
#         confusion_matrix = get_confusion_matrix(num_snr, snr_label_num, item_snr_index, results, item_snr_label)
